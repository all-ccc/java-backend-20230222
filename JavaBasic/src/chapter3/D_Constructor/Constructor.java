...
public class Constructor {
	...
	public static void main(String[] args) {
		...
		Circle circle1 = new Circle(); // Circle() : 생성 시 초기화해주는 메서드
		Circle circle2 = new Circle(5);
		System.out.println("==========");
//		System.out.println(circle1.radius); // 0으로 초기화된 상태
		
//		double radius;
//		System.out.println(radius); -> 오류뜸
