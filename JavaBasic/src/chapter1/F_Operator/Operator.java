...
public class Operator {
	...
	public static void main(String[] args) {
		...
		// 나눗셈 연산자 : /
		// 좌항에 우항을 나눈 값을 반환 (모두 몫만 반환하는 거 아님! 자료형에 따라)
		...
		// 증감 연산자 : '변수' 자신을 1 증가 혹은 감소
		
		// 증가 연산자 : ++
		// 연산자에 좌항 혹은 우항의 값을 1 증가시킴
		int integer1 = 10;
		++integer1;
...
//		상수에는 증감연산자 사용 불가능 (변수에만 적용 가능)
//		final int NUMBER = 0;
//		NUMBER++;	-> final로 지정해서 안됨
//		0++;	-> 리터럴 상수 자체 연산 불가능
		
		// 감소 연산자 : --
		// 연산자에 좌항 혹은 우항의 값을 1 감소시킴
		int integer2 = 10;
		--integer2;
		integer2--;
		...
		int number2 = 8;
		int number3 = 3;
		int sampleNumber = number2 / number3++; // ; 전에는 number3 = 3. ; 이후부터 4
		...
		// 좌항이 우항과 크거나 같으면 true, 아니면 false 반환
		...
		// 논리 연산자
		// 논리 값을 연산하는 연산자 (좌항과 우항 둘 다 논리값이 있어야)\
		...
		// ! number5 = 8임 -> 앞에서 false가 나왔기 때문에 뒤의 연산은 아예 안 읽음
		...
		System.out.println(number5);
		// number5 = 8임 -> 앞에서 true가 나왔기 때문에 뒤의 연산은 아예 안 읽음
